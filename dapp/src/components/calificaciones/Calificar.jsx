        ...
        <form>
          ...
          <button
            ...
            onClick={async (ev) => {
              ...
              if (!account) {
                throw new Error(
                  "No se puede acceder a las cuentas de usuario.",
                );
              }

              setResult("Enviando petición.");

              const r = await asignatura.califica(
                alumnoAddr,
                indexEval,
                tipo,
                calificacion,
              ...
              if (r.receipt.status === true) {
                setResult("La transacción fue exitosa.");
              } else if (r.receipt.status === false) {
                setResult("La transacción falló.");
              } else {
                setResult("La transacción está pendiente.");
              }
            }}
          >
            Calificar
